import { retrieveRelationsAndKnowledge } from '../src/routes/question/helper';
...
function answerInTopic (
  ...
  retrieveRelationsAndKnowledge(question, topic, subTopic, tagDB, relationDB)
    .then((res) => {
      console.dir(res, { depth: 10 });
    })
}

// answerInTopic('Where can I live in Lyon?', 'REAL_ESTATE', 'NEW', 'realestate_new_tag', 'realestate_new_relation')
